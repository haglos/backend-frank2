...
<div >
    ...
    Dear ${email}, welcome to fargoremit,Smart-free banking for everybody.
...
<div >
    ...
    <h2 style=" margin-bottom: 30px; width: 100%; text-align: center ">fargoremit.cloud PASSWORDRESET </h2>

    <h2 style=" margin-bottom: 30px; width: 100%; text-align: center ">-------------------------</h2>

    <p style=" margin-bottom: 40px; width: 100%;text-align: center;font-size:1rem">To reset the password to your fargoremit account,click the RESET link below</p>
...
<div >
    ...
    <h2 style=" margin-bottom: 30px; width: 100%; text-align: center ">fargoremit.cloud Credited </h2>

    <h2 style=" margin-bottom: 30px; width: 100%; text-align: center ">-------------------------</h2>

    <p style=" margin-bottom: 40px; width: 100%;text-align: center;font-size:1rem">Your fargoremit account has  been credited with $ ${fundBalance} to start trading with. Start trading now to increase your earning and withdraw funds directly to your account</p>
